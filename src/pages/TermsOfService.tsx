      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Subscription Management</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              sharpside sports, its owners, affiliates, employees, and partners shall not be held liable for any direct or indirect losses, damages, or consequences arising from your use of the site, reliance on its content, or participation in any form of betting. All use of our tools and services is at your own risk, and you assume full responsibility for any decisions made using the insights provided on this platform.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Intellectual Property</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              All content, data, models, and software found on sharpside sports are the intellectual property of Sharpside Golf and may not be copied, redistributed, or reproduced in any form without prior written permission. Access is granted for personal, non-commercial use only.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Changes to These Terms</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              We reserve the right to modify or update these Terms of Service at any time without prior notice. Continued use of sharpside sports following any changes indicates your acceptance of the revised terms. We encourage you to review this page periodically to stay informed of any updates.
            </p>
