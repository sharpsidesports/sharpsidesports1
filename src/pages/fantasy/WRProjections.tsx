...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1ZpZL0XJifFr_m04k4qpDlPgPbsuJQA5tg9Uyv6JTpB0/gviz/tq?tqx=out:csv';
...
export default function WRProjections() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const headerRowIdx = data.findIndex(
          row => row.includes('Player') && row.includes('Rec. Yards Line')
        );
        if (headerRowIdx === -1) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">WR Projections</h1>
      {loading ? (
