...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1YKqdoOCCcuYtpHKs3fP9gGw_3fXCHJVDkwZ4R9UJ6sw/gviz/tq?tqx=out:csv';

export default function PassAttemptsPerGame() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Hardcoded header
        const hardcodedHeaders = ['Rank','Team','2024','L3 Games','Last Game','Home','Away','2023'];
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Pass Attempts per Game</h1>
      {loading ? (
