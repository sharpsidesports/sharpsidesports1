...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1fnP2VEmDJKIA29Lgn1q5HgjD9DiN6mCQcare27EElIo/gviz/tq?tqx=out:csv';

export default function DefenseRushingYardsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Rushing Yards Per Game Allowed</h1>
      {loading ? (
