...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1_ycL4DDRZrStH50pqSr_iPJ-GVqKACBgMZR7utJ_GeI/gviz/tq?tqx=out:csv';

export default function DefenseCompletionsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Completions Allowed Per Game</h1>
      {loading ? (
