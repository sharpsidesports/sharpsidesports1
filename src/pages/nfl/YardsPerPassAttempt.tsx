...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1wXJvJmUMnOUZLhX5EmPNUs6GgoQcKXU2zdxl78dhFHc/gviz/tq?tqx=out:csv';

export default function YardsPerPassAttempt() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards per Pass Attempt</h1>
      {loading ? (
