...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1PJzd0KAdk__jO9kK8QnLAdiXdDck9hxwadTngRu-8MQ/gviz/tq?tqx=out:csv';

export default function RushingAttemptsPerGame() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const headerRowIdx = data.findIndex(row => row.some(cell => cell && cell.trim() !== ''));
        if (headerRowIdx === -1) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Rushing Attempts Per Game</h1>
      {loading ? (
