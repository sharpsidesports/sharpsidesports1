...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1aj8fCdMtOk6b5X7RpqhU3J3ci_AO-GSf0-dOPZbP9DM/gviz/tq?tqx=out:csv';

export default function RushingYardsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Rushing Yards Per Game</h1>
      {loading ? (
