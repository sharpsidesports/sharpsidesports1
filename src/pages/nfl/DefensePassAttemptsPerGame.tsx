...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1ouZ5jiMMqU68vPP7iNOy8MePtizLFVW6ufsoWD2Xe94/gviz/tq?tqx=out:csv';

export default function DefensePassAttemptsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Pass Attempts Per Game Allowed</h1>
      {loading ? (
