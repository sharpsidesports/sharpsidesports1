...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1zds7XCyf91uy6vBudxb6tRribPm-JbtorCxavOZD488/gviz/tq?tqx=out:csv';

export default function DefenseYardsPerCompletion() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards Per Completion Allowed</h1>
      {loading ? (
