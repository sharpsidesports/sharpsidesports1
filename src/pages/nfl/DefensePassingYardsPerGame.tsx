...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1fMlA3mpS6Wbu_Kq05GIiAOEGePE6s5t8z3fUsMzAaPs/gviz/tq?tqx=out:csv';

export default function DefensePassingYardsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Passing Yards Allowed Per Game</h1>
      {loading ? (
