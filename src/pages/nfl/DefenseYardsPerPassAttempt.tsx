...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1UeJvN8loAvvo-HSfxQySUit1c-tEservRbxvtvOx_iU/gviz/tq?tqx=out:csv';

export default function DefenseYardsPerPassAttempt() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards Per Pass Attempt Allowed</h1>
      {loading ? (
