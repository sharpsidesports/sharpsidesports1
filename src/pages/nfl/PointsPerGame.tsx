...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1FTkFtYLTfmiHaRtxynd0RvKjWLBUqpBaeziesOWcKQA/gviz/tq?tqx=out:csv';

export default function PointsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Points Per Game</h1>
      {loading ? (
