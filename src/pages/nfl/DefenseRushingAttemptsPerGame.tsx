...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1bcq0JdSUqaPd8Ylz7wAoCkxY6SO7yJA5J8IJXjgWk1k/gviz/tq?tqx=out:csv';

export default function DefenseRushingAttemptsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Rushing Attempts Per Game Allowed</h1>
      {loading ? (
