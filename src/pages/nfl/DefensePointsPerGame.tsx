...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1XaNV0jZIckbAJdlsesNYMkGHz_MDiYpsCr6h1-09Neo/gviz/tq?tqx=out:csv';

export default function DefensePointsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Points Per Game Allowed</h1>
      {loading ? (
