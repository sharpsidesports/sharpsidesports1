...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/16i0MlJbszQdNt93Vch1HBK03YWgNOPKhFbGRG7w0zvQ/gviz/tq?tqx=out:csv';

export default function YardsPerCompletion() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards per Completion</h1>
      {loading ? (
