...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1HgZyriKIkP4liKBg7TsQdhk4QS5y5z3eRA6B6aQ6pNc/gviz/tq?tqx=out:csv';

export default function DefenseYardsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards Per Game Allowed</h1>
      {loading ? (
