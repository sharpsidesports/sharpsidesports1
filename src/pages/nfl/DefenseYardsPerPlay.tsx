...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1a2SoBZ2qBluQkWEVt9B-noskRdjSGd_QOKwzhTU8SIg/gviz/tq?tqx=out:csv';

export default function DefenseYardsPerPlay() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards Per Play Allowed</h1>
      {loading ? (
