...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1jiAtbezZcYMXSJpQQVpquNS97s9cz4R5UBTM3talN80/gviz/tq?tqx=out:csv';

export default function YardsPerGame() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Yards Per Game</h1>
      {loading ? (
