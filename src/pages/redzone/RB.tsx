...
const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/1-X6QL3NZEGr9NIRRMaAmkWWTtPXKkA8cit_rZygVXtg/gviz/tq?tqx=out:csv';

export default function RBRedzoneStats() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Running Back Redzone Stats</h1>
      {loading ? (
