...
export const getPlayerName = (dgId: string): string => {
  const player = playerMappings.find(p => p.dg_id === dgId);
  return player ? player.name : dgId.toString();
};
